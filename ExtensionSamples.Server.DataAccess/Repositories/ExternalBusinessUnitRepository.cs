...
{
    public class ExternalBusinessUnitRepository : IBusinessUnitRepository
    {
        private readonly IBusinessUnitRepository _coreImplementation;
        private readonly Storix_PortalEntities _context;
        public ExternalBusinessUnitRepository(Storix_PortalEntities context, IBusinessUnitRepository coreImplementation)
        {
